...
1. **`easy_marl/src/core/agents.py`**
...
1. **Requirement**: extensive unit tests in `tests/unit_tests/core` must achieve 100% code coverage against `src/core`.
...
1. **End-to-End**: Run `python examples/bidding/main.py`
